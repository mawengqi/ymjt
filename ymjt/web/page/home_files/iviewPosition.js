...
//			textWidthList.push(parseInt(getStyle(textBox,'width'))+parseInt(getStyle(textBox,'padding-left'))*2);
//			textHeightList.push(parseInt(getStyle(textBox,'height'))+parseInt(getStyle(textBox,'padding-top'))*2);
			i++;
